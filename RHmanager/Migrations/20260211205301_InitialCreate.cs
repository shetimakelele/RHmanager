        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnnualLeaveDays = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    RemainingLeaveDays = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    DepartmentId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValidationComment = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LeaveRequests_Employees_ValidatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequests_ValidatedById",
                table: "LeaveRequests",
